...
mod tests{
    ...
    fn test_autocomplete(){
        assert!(autocomplete("Dashboard").is_some(),"failed to autocomplete dashboard");
        assert!(autocomplete("Pane").is_some(),"failed to autocomplete dashboard");
        assert!(autocomplete("blsh").is_none(),"autocompleted to something when the string was not in the list of autocompletes");
