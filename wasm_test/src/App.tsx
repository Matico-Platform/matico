...
import { ValidationResult } from "rust_to_typescript_test";
...
function App() {
  ...
  const annotations: Ace.Annotation[] = jsonError ? json_error_to_annotation(jsonError) : [];
  ...
  return (
    ...
    >
      ...
      />
      <div
        style={{ width: "50%", height: "100%", borderLeft: "1px solid black" }}
      >
        {validJSON
