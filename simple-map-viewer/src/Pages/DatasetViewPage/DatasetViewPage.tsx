...
export const DatasetViewPage: React.FC = () => {
    ...
    const { data, loading: dataLoading, error,pages, page,setPage} = useDataSource(dataQueryStrategy, {perPage});
                ...
                {dataset && (
                    <Styles.Content>
                        <Styles.Table>
                            ...
                            <DataTable
                                data={data}
                                selectedID={selectedRow ? selectedRow[dataset.id_col] : null}
                        ...
                        <Styles.Map>
                            ...
                            >
                                ...
                                {  (hoverInfo && hoverInfo.object) &&
                                    <HoverToolTip x={hoverInfo.x} y={hoverInfo.y} info={hoverInfo.object.properties} />
                                }
                            </DeckGL>
                        </Styles.Map>
