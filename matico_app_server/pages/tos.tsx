...
export default function Tos() {
  return (
    <Content
      ...
      UNSAFE_style={{
        width: "100%",
        background: "linear-gradient(to top left, #793169, #282848)",
      }}
    >
      <Header />
      <div
      ...
      >
        ...
        <p>Welcome to Matico App Server!</p>
        ...
        <p>
          ...
          conditions. Do not continue to use Matico App Server if you do not
        ...
        <p>
          Unless otherwise stated, Matico and/or its licensors own the
          intellectual property rights for all material on Matico App Server.
          All intellectual property rights are reserved. You may access this
          from Matico App Server for your own personal use subjected to
        ...
        <ul>
          <li>
            Violate the terms of our MIT open source license. See our{" "}
            <a
        ...
        <p>
          ...
          Matico does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Matico,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, Matico shall not be liable
        ...
        <p>
          Matico reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Matico a non-exclusive license to use, reproduce,
