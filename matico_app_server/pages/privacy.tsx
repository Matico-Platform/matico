  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          Matico built the Matico App Server app as an Open Source app. This
          SERVICE is provided by Matico at no cost and is intended for use as
          is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Matico App Server unless
        ...
        <p>
          ...
          including but not limited to Name, Email, Social Connection. The
        ...
        <p>
          ...
          not hesitate to contact us at dhalpern@uchicago.edu.
        </p>{" "}
        <p>
