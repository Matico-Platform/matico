    ...
    <SessionProvider session={pageProps.session}>
      <SSRProvider>
        <Provider theme={darkTheme} colorScheme="dark">
          ...
          <span style={{ fontSize: "10px" }}>We use LogRocket for analytics. Read more about their <a target="_blank" rel="noreferrer" href="https://logrocket.com/privacy/#:~:text=How%20LogRocket%20Collects%20Cookies,when%20you%20visit%20other%20sites.">privacy policy</a></span>
        </CookieConsent>
      </Provider>
    </SSRProvider>
    </SessionProvider>
