...
export class QueryBuilder{
    ...
    fromParams(params: Record<string,any>){
      ...
      if(params.hasOwnProperty("collaborators") && params.collaborators==='true'){
        this.query.include = {...this.query.include , collaborators : true}
      }

      if(params.hasOwnProperty("includeOwner") && params.includeOwner==='true'){
        this.query.include = {...this.query.include , owner: true}
      }

      if (params.hasOwnProperty("order")) {
        this.query.orderBy[params.order as string] = params.orderDir ? params.orderDir : "desc";
      }
