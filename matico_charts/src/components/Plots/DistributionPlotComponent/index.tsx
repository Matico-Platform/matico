...
export const DistributionPlotComponent = (
            ...
            <g key={i}>
              ...
              {showBoxPlot ? (
                <BoxPlot
                  ...
                  minProps={{
                    onMouseMove: (event) => {
                      handleMouseOver(event, { min: min(d), name: x(d) });
                    },
                    onMouseLeave: () => {
                      hideTooltip();
                    },
                  ...
                  maxProps={{
                    onMouseMove: (event) => {
                      handleMouseOver(event, { max: max(d), name: x(d) });
                    },
                    onMouseLeave: () => {
                      hideTooltip();
                    },
                  ...
                  boxProps={{
                    onMouseMove: (event) => {
                      handleMouseOver(event, { ...d.boxPlot, name: x(d) });
                    },
                    onMouseLeave: () => {
                      hideTooltip();
                    },
                  ...
                  medianProps={{
                    ...
                    onMouseMove: (event) => {
                      handleMouseOver(event, { median: median(d), name: x(d) });
                    },
                    onMouseLeave: () => {
                      hideTooltip();
                    },
