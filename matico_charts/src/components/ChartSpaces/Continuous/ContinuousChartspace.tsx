...
import {
    ChartStoreAndActions,
    useStore,
} from "../../../Store/maticoChartStore";
import {
    getBoolOrProperty,
    isFunc,
    isObj,
...
import { AxisSpec, ContinuousChartSpec, DataRow } from "../../types";
...
function useStateValueListener<StateKey extends keyof ChartStoreAndActions>(
    key: StateKey,
    updater: () => () => void,
    dependency: any[]
