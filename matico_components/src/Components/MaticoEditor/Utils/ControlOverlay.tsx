    ...
    return (
        <ControlBarContainer>
            <View
                ...
                borderWidth="thin"
            >
                <ControlButton paneRef={paneRef} action="move" />
            </View>
            ...
            >
                <View
                    ...
                    borderWidth="thin"
                >
                    <ControlButton paneRef={paneRef} action="edit" />
                </View>
                <View
                    ...
                    borderWidth="thin"
                >
                    <ControlButton paneRef={paneRef} action="delete" />
                </View>
            </Flex>
            ...
            <View
                ...
                bottom="size-50"
            >
                <ControlButton paneRef={paneRef} action="resize" />
            </View>
            <View
                backgroundColor="informative"
                ...
                bottom="0px"
            >
                <ControlButton paneRef={paneRef} action="resizeY" />
            </View>
            <View
                backgroundColor="informative"
                ...
                right="0px"
            >
                <ControlButton paneRef={paneRef} action="resizeX" />
            </View>
        </ControlBarContainer>
    );
};
