...
export const URLImporter: React.FC<DatasetProviderComponent> = ({
  ...
  const [format,setFormat]= useState<"geoJSON" | "csv" | "arrow">("geoJSON")
    ...
    <Flex direction="column" gap="size-200">
      <Flex direction="row" alignItems='center' gap='size-200'>
        <TextField
          ...
          flex={1}
        />
      <Picker label='format' selectedKey={format} onSelectionChange={(format)=>setFormat(format)}>
      ...
      <Button variant='cta' onPress={submit}>Add Dataset</Button>
