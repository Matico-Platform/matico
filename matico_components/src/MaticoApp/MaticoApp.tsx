...
import { MaticoAppPresenter } from "../Components/MaticoAppPresenter/MaticoAppPresenter";
import { MaticoEditor } from "Components/MaticoEditor";
...
export const MaticoApp: React.FC<MaticoAppInterface> = ({
    ...
    const [responsiveViewportLimit, setResponsiveViewportLimit] =
